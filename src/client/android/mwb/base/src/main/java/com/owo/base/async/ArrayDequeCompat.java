 ...
 * usage. They are not thread-safe; in the absence of external synchronization,
 * they do not support concurrent access by multiple threads. Null elements are
 * prohibited. This class is likely to be faster than {@link java.util.Stack}
 * when used as a stack, and faster than {@link java.util.LinkedList} when used
 * as a queue.
 * <p/>
 * <p/>
 ...
 * @since 1.6
 */
public class ArrayDequeCompat<E> extends AbstractCollection<E> implements Cloneable, java.io.Serializable {
    /**
